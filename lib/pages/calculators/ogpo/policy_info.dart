...
class PolicyAgreement extends GetView<PolicyController> {
  PolicyAgreement({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    date.text = "С " + agreement.fromDate + " по " + agreement.tillDate!;
    ...
    List<TextEditingController> drivers = List.generate(
        ...
        (i) => TextEditingController(text: agreement.insured[i]));
    List<TextEditingController> vehicles = List.generate(
        agreement.objects.length,
        (i) => TextEditingController(text: agreement.objects[i]));
    return Scaffold(
