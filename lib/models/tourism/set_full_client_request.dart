...
class SetFullClientRequest {
  ...
  SetFullClientRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
  ...
  static SetFullClientRequest to(Insurer insurer) {
    return SetFullClientRequest(
      id: 0,
      isResident: 1,
      iin: insurer.iin!.text,
      firstName: insurer.name!.text.toUpperCase(),
      lastName: insurer.surname!.text.toUpperCase(),
      middleName: insurer.dadsName!.text.toUpperCase(),
      birthDate: insurer.birthDate!.text,
      phone: insurer.phone == null ? '' : insurer.phone!.text,
      sportCategoryId: 0,
      sportId: 0,
      address: insurer.address!.text,
      isBeneficiary: insurer.isBeneficiary,
      sexId: insurer.sexId!,
      firstNameEng: insurer.nameEng!.text.toUpperCase(),
      lastNameEng: insurer.surnameEng!.text.toUpperCase(),
      documentNumber: insurer.docnum!.text,
      documentGivenBy: insurer.whoGave,
      documentIssueDate: insurer.whenGiven!.text,
      documentTypeId: insurer.documentTypeId,
      documentPassport: null,
      isic: true,
      isicPhoto: null,
      error: '',
      classs: insurer.classs,
      isIndividual: insurer.isIndividual,
      countryId: insurer.countryId,
      legalName: '',
      economicsSectorId: insurer.economicsSectorId,
      activityKindId: insurer.activityKindId,
      isExperienced: insurer.isExperienced,
      isPrivileged: insurer.isPrivileged,
      priveledges: insurer.priveledges,
      recaptcha: insurer.recaptcha,
    );
  }
}
